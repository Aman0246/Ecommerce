  ...
  return (
      ...
      <div  className=" w-full pt-2 fixed flex flex-wrap  bg-white shadow-md items-center  justify-between px-5 pb-2 md:px-10 ">
        ...
        <div className=" text-gray-500 md:text-2xl  bg-white flex gap-3 md:gap-7">
          ...
          <div className="relative">
            <div onClick={handleUserMenu} className="hover:text-2xl cursor-pointer  hover:text-gray-700">
              <FaRegUserCircle></FaRegUserCircle>
            </div>
            {showmenu && (
              <div className="absolute right-0 bg-white py-2 px-2 shadow drop-shadow-md ">
                <p onClick={handleUserMenu}  className="whitespace-nowrap cursor-pointer hover:bg-gray-100 px-5 rounded-lg">
